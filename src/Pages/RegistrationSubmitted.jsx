        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 3 }}>
            ...
            <Box>
              ...
              <Typography variant="body1" color="text.secondary">
                An authorized approver will review your registration and verify all submitted
                information.
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
            ...
            <Box>
              ...
              <Typography variant="body1" color="text.secondary">
                You will receive an email notification with the approval decision or rejection
                reasons.
              </Typography>
            </Box>
          </Box>
