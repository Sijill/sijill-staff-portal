...
const RegistrationForm = ({
  ...
  const handleChange = (e) => {
    ...
    if (files?.[0]) {
      ...
      if (!['image/png', 'image/jpeg', 'application/pdf'].includes(file.type)) {
        setErrors((prev) => ({
          ...prev,
          [name]: 'Invalid file type. Please upload PNG, JPG, or PDF files only.',
        }));
        return;
      }
      ...
      if (file.size > maxSize) {
        setErrors((prev) => ({
          ...prev,
          [name]: `File too large. Max size: ${maxSize / (1024 * 1024)}MB`,
        }));
        return;
      }
  ...
  const validateForm = () => {
    ...
    if (registrationType === 'healthcare-provider') {
      ...
      else if (!/^\d{11}$/.test(normalizePhoneNumber(formData.contactPhone)))
        errs.contactPhone = 'Phone number must be 11 digits';
      if (!formData.nationalId) errs.nationalId = 'National ID is required';
      else if (!/^\d{14}$/.test(formData.nationalId))
        errs.nationalId = 'National ID must be 14 digits';
      if (!formData.gender) errs.gender = 'Gender is required';
      if (!formData.medicalLicenseNumber)
        errs.medicalLicenseNumber = 'Medical license number is required';
      ...
      if (!formData.medicalLicenseDoc)
        errs.medicalLicenseDoc = 'Medical license document is required';
      ...
      if (!formData.accreditationNumber)
        errs.accreditationNumber = 'Accreditation number is required';
          ...
          <Col md={6}>
            <Form.Group controlId="email">
              ...
              <Form.Control
                ...
                placeholder="HCP.email@example.com"
        ...
        <Row className="mb-3">
          ...
          <Col md={4}>
            <Form.Group controlId="middleName">
              <Form.Label className="d-flex align-items-center">
                Middle name <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
                name="middleName"
          ...
          <Col md={4}>
            <Form.Group controlId="lastName">
              <Form.Label className="d-flex align-items-center">
                surname <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
                name="lastName"
        ...
        <Row className="mb-3">
          ...
          <Col md={4}>
            <Form.Group controlId="contactPhone">
              <Form.Label className="d-flex align-items-center">
                Contact Phone <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="tel"
                name="contactPhone"
        ...
        <Row>
          <Col md={6}>
            <Form.Group controlId="medicalLicenseNumber">
              <Form.Label className="d-flex align-items-center">
                Medical license number <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
        ...
        <Row className="mb-3">
          <Col md={12}>
            <Form.Group controlId="workplaceName">
              <Form.Label className="d-flex align-items-center">
                Workplace Name <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
                name="workplaceName"
        ...
        <Row className="mb-3">
          <Col md={12}>
            <Form.Group controlId="workplaceAddress">
              <Form.Label className="d-flex align-items-center">
                Workplace Address <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
                ...
                onChange={handleChange}
                placeholder="Enter full workplace address"
                isInvalid={!!errors.workplaceAddress}
              />
              <Form.Control.Feedback type="invalid">
        ...
        <Row className="mb-3">
          <Col md={12}>
            <Form.Group controlId="centerName">
              <Form.Label className="d-flex align-items-center">
                Center name <span className="text-danger ms-1">*</span>
              </Form.Label>
              <Form.Control
                type="text"
                name="centerName"
                ...
                onChange={handleChange}
                placeholder={`Enter ${entityType.toLowerCase()} center name`}
        ...
        <Row className="mb-3">
          <Col md={12}>
            <Form.Group controlId="accreditationNumber">
              <Form.Label className="d-flex align-items-center">
                National/Commercial Registration or Accreditation Number{' '}
              ...
              <Form.Control
                ...
                onChange={handleChange}
                placeholder="Enter Registration or Accreditation Number"
                isInvalid={!!errors.accreditationNumber}
              />
              <Form.Control.Feedback type="invalid">
          ...
          <Col md={6}>
            <Form.Group controlId="email">
              ...
              <Form.Control
                ...
                value={formData.email}
                onChange={handleChange}
                placeholder={`${entityType.toLowerCase()}.center@example.com`}
                isInvalid={!!errors.email}
              />
              <Form.Control.Feedback type="invalid">{errors.email}</Form.Control.Feedback>
            </Form.Group>
  ...
  return (
    <div
      className="min-vh-100 min-vw-100 d-flex flex-column"
      style={{ backgroundColor: '#e6f7ff' }}
    >
      <Container className="mt-3" style={{ maxWidth: '900px' }}>
        <div className="text-center mb-3">
          <h1 className="mb-1" style={{ fontWeight: 700, fontSize: '1.8rem' }}>
        ...
        <Card className="rounded-4 p-4" style={{ backgroundColor: 'white', border: 'none' }}>
          ...
          <div className="mb-4">
            <h3 className="mb-1" style={{ fontWeight: 700, fontSize: '1.5rem' }}>
              {title}
            </h3>
